	...
	public function display()
	{
		...
		foreach($languages as $id=>$abb)
		{
			...
			if($id == $_SESSION['language_id'])
				$langs []= '<li class="selected_language">'.$GLOBALS['config']['languages_short'][$id].'</li>';
			else
				$langs []= '<li><a href="'.$uri.'?lan='.$abb.'" title="'.$GLOBALS['config']['languages_long'][$id].'">'.$GLOBALS['config']['languages_short'][$id].'</a></li>';
		}	
		//add links to specific sites as defined in the confix file
